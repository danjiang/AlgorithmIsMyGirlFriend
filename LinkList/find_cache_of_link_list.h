...
#ifndef ALGORITHMISMYGIRLFRIEND_LINKLIST_FIND_CACHE_OF_LINK_LIST_H_
#define ALGORITHMISMYGIRLFRIEND_LINKLIST_FIND_CACHE_OF_LINK_LIST_H_
...
#endif //ALGORITHMISMYGIRLFRIEND_LINKLIST_FIND_CACHE_OF_LINK_LIST_H_
